...
class LiveChatMessage(object):
    ...
    # Define official string representation of the object... IE when print(this object) is called it will print this:
    def __repr__(self):
        if PY3:
...
class YoutubeLiveChat(object):
                        ...
                        while result['items']:
                            ...
                            if new_msg_objs:
                                ...
                                for callback in self.chat_subscribers:
                                    try:
                                        callback(new_msg_objs, chat_id) # This is the Call to "respond" function in example.py
                                    except:
    ...
    def subscribe_chat_message(self, callback):
        self.chat_subscribers.append(callback) # callback is our respond function in example.py
