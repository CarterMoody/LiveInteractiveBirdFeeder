...
APIKeySnapyIO = 'pub_5d7113951477b132eeeb9ddd-7020bd56-9f03-445c-9787-05670070550a'   # API Key from Snapy.io
APIKeyBlockIO = "0d76-078a-c2c9-e524"                                                 # API Key from Block.io
#######################################
##### New SNAPY API info items ########
headersNANO = {'x-api-key': 'pub_5d7113951477b132eeeb9ddd-7020bd56-9f03-445c-9787-05670070550a'}    # API Key from Snapy.io
...
def loop():
    ...
    niceWait(3)    #Delay between requests... not sure if helps against ERROR 429 
